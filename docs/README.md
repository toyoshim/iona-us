...
## 互換性
### JVSシステム
[MP01-IONA-JS](../iona-js/)と同様に、現存するほぼ全てのJVSシステムに対応しています。また、現状ではnaomiの電脳戦機バーチャロン オラトリオ・タングラムの特殊レイアウトにも対応しています。詳細は後述のツインスティックモードの説明を御覧ください。
...
### ファームウェアのバージョン
- 初期出荷版はVer 1.01、お盆休み以降の出荷版はVer 1.10になっています。
