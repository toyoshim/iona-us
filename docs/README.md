...
|1|2|3|機能|
|-|-|-|-|
|OFF|-|-|デバイス名の問い合わせに対し、SEGA互換のI/Oを名乗る|
|ON|-|-|デバイス名の問い合わせに対し、namco互換のI/Oを名乗る (*1)|
|-|-|OFF|JVSデータ信号レベル補正を有効にする|
|-|-|ON|JVSデータ信号レベル補正を無効にする|
...
### ファームウェアのバージョン
- 最新版ではVer 1.35が初期状態で書き込まれています。バージョンはデバイス名として確認可能です。
