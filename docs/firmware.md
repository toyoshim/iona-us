...
### v1/v2/v3ボードで両端USB Type Aの特殊ケーブルを使う場合
電源接続は不要です。SERVICEを押しながら1P用端子を両端Type AのケーブルでPCに接続するだけで更新可能です。
...
- Ver 2.23 シフトギアエミュレーションにニュートラルのサポートを追加
